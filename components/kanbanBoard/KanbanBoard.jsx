...
const DynamicCreatePortal = dynamic(() => import("react-dom").then((mod) => mod.createPortal), {
  ssr: false,
});
...
function KanbanBoard() {
  ...
  //     // Create the portalContainer when the component mounts
  ...
  //   return () => {
  //     // Remove portalContainer when the component unmounts
  ...
  //   console.log(defaultTasks,"deeefe")
  // }
